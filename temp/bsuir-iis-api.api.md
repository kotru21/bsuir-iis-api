...
// @public
export function getCurrentLesson<T extends LessonWithTime>(lessons: readonly T[], now?: Date): T | null;
...
// @public
export function getNextLesson<T extends LessonWithTime>(lessons: readonly T[], now?: Date): T | null;
